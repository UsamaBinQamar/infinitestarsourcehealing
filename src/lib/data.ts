...
export const energyHealingMethods: EnergyHealingMethod[] = [
  {
    ...
    description: "Experience the power of energy healing from any location. Our practitioners can send healing energy across any distance to support your wellbeing."
  },
  {
    id: 2,
    icon: "brain",
    title: "Chakra Balancing",
    description: "Restore harmony to your energy centers through specialized chakra balancing techniques that clear blockages and promote flow."
  },
  {
    id: 3,
    icon: "sun",
    title: "Aura Cleansing",
    description: "Clear negative energies from your aura and create a protective shield around your energy field for improved wellbeing."
  }
];
...
export const reikiBenefits: ReikiBenefit[] = [
  {
    id: 1,
    title: "What is Reiki?",
    description: "Reiki is a Japanese form of energy healing—a type of alternative medicine. Reiki practitioners use a technique called palm healing or hands-on healing through which a \"universal energy\" is said to be transferred through the palms of the practitioner to the patient in order to encourage emotional or physical healing.",
    imageUrl: "https://images.unsplash.com/photo-1591291621164-2c6367723315?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80"
  },
  {
    id: 2,
    title: "Benefits of Reiki",
    description: "Reiki promotes relaxation, reduces stress and anxiety, and may help relieve pain. Many people report feeling clearheaded and physically refreshed after a session. Regular Reiki treatments can bring about a calmer and more peaceful state of being, in which you feel more able to cope with the challenges of life.",
    imageUrl: "https://images.unsplash.com/photo-1598387993281-cecf8b71a8f8?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80"
  }
];
...
export const subscriptionOptions: SubscriptionOption[] = [
  {
    ...
    description: "Receive a weekly distance Reiki session for general wellbeing and maintenance.",
    icon: "leaf",
    color: "primary"
  },
  {
    ...
    type: "healing",
    title: "Healing Focus",
    description: "Target specific health concerns with customized distance Reiki sessions.",
    icon: "heart",
    color: "secondary"
  },
  {
    ...
    description: "Receive energy work focused on emotional healing and spiritual growth.",
    icon: "brain",
    color: "accent"
  }
];
...
export const galleryImages: GalleryImage[] = [
  {
    id: 1,
    imageUrl: "https://images.unsplash.com/photo-1474418397713-2f2a2a5a1795?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80",
  ...
  {
    id: 2,
    imageUrl: "https://images.unsplash.com/photo-1531299244174-d247dd4e5a66?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80",
  ...
  {
    id: 5,
    imageUrl: "https://images.unsplash.com/photo-1498019559366-a1cbd07b5160?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80",
  ...
  {
    id: 6,
    imageUrl: "https://images.unsplash.com/photo-1517097973722-d45948f7f5f4?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80",
  ...
  {
    id: 7,
    imageUrl: "https://images.unsplash.com/photo-1528495612343-9ca9f4a4de28?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80",
  ...
  {
    id: 8,
    imageUrl: "https://images.unsplash.com/photo-1536623975707-c4b3b2af565d?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80",
...
export const faqItems: FaqItem[] = [
  ...
  },
  {
    ...
    answer: "Our services are offered for free because we believe that healing energy should be accessible to everyone, regardless of financial circumstances. Our practitioners volunteer their time and expertise as a form of service to the community. Many find that offering healing to others enhances their own wellbeing and spiritual growth. We are supported by optional donations and community contributions."
  },
  {
    id: 5,
    question: "How often should I receive energy healing?",
    answer: "The frequency of energy healing sessions depends on your individual needs and circumstances. For acute situations or intense healing periods, more frequent sessions (even daily) may be beneficial. For general wellbeing maintenance, weekly or bi-weekly sessions are common. Some people find that monthly sessions help them stay balanced. Listen to your body and intuition—you'll likely develop a sense of when you would benefit from additional energy support."
  }
];

export const contactInfo: ContactInfo = {
  email: "hello@freereikihealing.org",
